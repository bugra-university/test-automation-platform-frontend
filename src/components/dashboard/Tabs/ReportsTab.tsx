...
export function ReportsTab({ selectedProjectId }: ReportsTabProps) {
  ...
  // Convert API reports to grid format
  ...
  const renderContent = () => {
    ...
    return (
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 md:gap-2 max-w-7xl mx-auto">
        {reportCards.map((feature) => (
          <div
            key={`report-${feature.reportId}`}
            className="relative bg-gradient-to-b dark:from-neutral-900 from-neutral-100 dark:to-neutral-950 p-6 rounded-3xl overflow-hidden hover:transform hover:-translate-y-1 transition-all duration-200 cursor-pointer h-72 flex flex-col"
          ...
          >
            ...
            {selectedCard === feature.reportId && feature.reportId && (
              <div className="absolute bottom-0 left-0 right-0 dark:bg-neutral-800 border-t border-neutral-200 dark:border-neutral-700 p-4 rounded-b-3xl animate-in slide-in-from-bottom-2 duration-200 z-30">
